...
<p>
    So what comes next? On <?= $fundingCycle->vote_begin->format('F j, Y') ?>, voting will begin for the
    applications in this funding cycle. Then on <?= $fundingCycle->vote_end->format('F j, Y') ?>, the
