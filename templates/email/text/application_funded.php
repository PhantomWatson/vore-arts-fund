 ...
 */
?>
Congratulations, <?= $userName ?>! We've tallied the votes for the <?= $fundingCycle->name ?> funding cycle, and we're thrilled to tell you that the community ranked your application for funding for <?= $application->title ?> high enough that it was selected to receive a $<?= number_format($amount) ?> loan!
...
When you're ready, visit <?= $myApplicationsUrl ?> to submit a report. And don't worry; we'll send you a reminder email about this if we haven't heard from you in a while.
