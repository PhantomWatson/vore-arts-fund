...
So what comes next? On <?= $fundingCycle->vote_begin_local->format('F j, Y') ?>, voting will begin for the applications
in this funding cycle. Then on <?= $fundingCycle->vote_end_local->format('F j, Y') ?>, the
